...
class ProcessingResult(BaseModel):
    ...
    response: str = Field(..., description="The response text to send back")
    classification: str = Field(..., description="The classified type of the message")
    ...
    classification: str = Field(..., description="The classification assigned by the AI")
    confidence: float = Field(default=0.0, ge=0.0, le=1.0, description="Confidence score of the classification")
    workflow_executed: bool = Field(default=False, description="Whether a workflow was executed")
